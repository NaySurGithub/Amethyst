...
public enum CheckType {
    ...
    BAD_PACKET_L("BadPacket-L", "Interacted with an entity that does not exist."),
    BAD_PACKET_M("BadPacket-M", "A block was placed against something the player was not looking at."),
    BAD_PACKET_N("BadPacket-N", "The predicted vehicle is not the one being ridden."),
    BAD_PACKET_O("BadPacket-O", "Position outside the bounds of the world."),
    BAD_PACKET_P("BadPacket-P", "Chunk radius outside the accepted range."),
