...
import nay.amethyst.check.AutoTotemCheck;
import nay.amethyst.check.BacktrackCheck;
import nay.amethyst.check.BadPacketCheck;
import nay.amethyst.check.BedrockToolDetector;
import nay.amethyst.check.CheckType;
import nay.amethyst.check.ChestStealerCheck;
import nay.amethyst.check.InventoryMoveCheck;
import nay.amethyst.player.GraceReason;
import nay.amethyst.player.PlayerData;
import nay.amethyst.world.BlockFrame;
import nay.amethyst.world.ClientEntityTracker;
import nay.amethyst.world.ClientWorldTracker;
...
public final class PacketListener implements Listener {
    ...
    public NetworkTimeline networkTimeline(Player player) {
        PlayerData data = players.get(player.getUniqueId());
